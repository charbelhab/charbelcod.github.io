                   ...
                   <div class="header-area header-transparrent">
                    ...
                    <div class="page-content">
                        <div class="form-v4-content">
                            ...
                            <form class="form-detail" action="forget_check.php" method="post" id="myform">
                                <h2>LOGIN</h2>
                                <?php
                                    if (isset($_SESSION["exist"]) && $_SESSION["exist"]==false){
                                        echo "<H4 style='color:red;'> You Email Doesn't Exist</H4>";
                                        session_destroy();
                                    }
                                ?>
                                <div class="form-row">
                                    ...
                                    echo '<input type="hidden" name="random" value="'.$rand.'">';
                                    ?>
                                </div>
                                <div class="form-group">
                                    ...
                                    <SELECT name="tag">
                                       ...
                                       <option value="c">Login As Company </option>
                                        ...
                                        <input type="submit" name="register" class="register" style ='width: 250px;' value="Send Verification Code">
                                        </div>
