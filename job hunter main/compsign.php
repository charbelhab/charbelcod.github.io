                    ...
                    <div class="page-content">
                        <div class="form-v4-content">
                            <div class="form-left">
                                ...
                                <div class="form-left-last">
                                    <A href="signup.php"><input type="button" name="account" class="account" value="User Signup"></A>
                                </div> 
                            </div>
                            <form class="form-detail" action="comptodb.php" method="post" id="myform" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-row form-row-1">
                                        <label for="companyname">Company Number </label>
                                        <input type="number" min="0" , max="9999999999999999999"name="compnum" onBlur="Validate()" class="input-text"required>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <?php
                                    if (isset($_SESSION["dbcomp"]) && $_SESSION["dbcomp"]==false){
                                ...
                                <div class="form-group">
                                    <div class="form-row form-row-1 ">
                                        ...
                                        <input type="password" name="password" id="password" onBlur="Validate()" maxlength="12" minlength="8" class="input-text" required>
                                    </div>
                                    <div class="form-row form-row-1">
                                        <label for="comfirm-password">Comfirm Password</label>
                                        <input type="password" name="comfirm_password"  onBlur="Validate()" id="comfirm_password" class="input-text" required>
                                    </div>
                                    
                                </div>
                                <label class="container">Company Logo </label>
